...
class Camera(object):
    ...
    def compute_camera_matrix(self):
        ...
        projection_matrix = p.computeProjectionMatrixFOV(self.fov_width, self.image_size[1] / self.image_size[0], self.near, self.far)  # TODO: compute projection_matrix from camera parameters
